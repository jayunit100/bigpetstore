...
/**
 * Borrowed from MRUnit.  No need to add the whole jar to the classpath just for this 
 * object.  Really only by {@link TransactionIteratorFactory}.
 * 
 * Deprecated because, eventually, we want to add guava or some other high-tech collections library
 * to the classpath and use DistributedCache deployer for it , rather than bundling source for stuff
 * like this.
 */
@Deprecated
