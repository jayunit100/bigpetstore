...
public class TransactionIteratorFactory {
    ...
    public static enum STATE {
        ...
        //Probabilities need to be readjusted with addition of remaining states
        AK(.1f,
                "dog-food_10", "cat-food_8", "fuzzy-collar_19",
                "antelope-caller_20", "salmon-bait_30"), 
        AL(.0f,
                "dog-food_10", "cat-food_8", "choke-collar_14",
                "fish-food_16", "salmon-bait_10"), 
        AR(.0f,
                "dog-food_10", "cat-food_8", "turkey-caller_20",
                "catfish-bait_14"), 
        ...
        DE(.0f, "dog-food_10",
                "cat-food_8", "chicken-feed_12", "hay-bail_2"), 
        FL(.0f, "dog-food_10",
                "cat-food_8", "fish-bait_20", "alligator-feed_4"), 
        GA(.0f, "dog-food_10",
                "cat-food_8", "cow-dung_9", "pig-feed_5"), 
        HI(.0f, "dog-food_10",
                "cat-food_8", "fish-food_18", "fish-bait_7"), 
        IA(.0f, "dog-food_10",
                "cat-food_8", "pig-feed_9", "chicken-feed_12"), 
        ID(.0f, "dog-food_10",
                "cat-food_8", "choke-collar_2", "turtle-pellets_3"), 
        IL(.0f, "dog-food_10",
                "cat-food_8", "cow-dung_14", "hay-bail_5"), 
        IN(.0f, "dog-food_10",
                "cat-food_8", "chicken-feed_24", "cow-dung_11"), 
        KS(.0f, "dog-food_10",
                "cat-food_8", "pig-feed_6", "cow-dung_7"), 
        KY(.0f, "dog-food_10",
                "cat-food_8", "horse-feed_22", "cow-dung_8"), 
        LA(.0f, "dog-food_10",
                "cat-food_8", "crawfish-bait_40", "chicken-feed_13"), 
        MA(.0f, "dog-food_10",
                "cat-food_8", "choke-collar_8", "lobster-bait_2"), 
        MD(.0f, "dog-food_10",
                "cat-food_8", "fish-bait_23", "cow-dung_3"), 
        ME(.0f, "dog-food_10",
                "cat-food_8", "lobster-bait_15", "fish-bait_7"), 
        MI(.0f, "dog-food_10",
                "cat-food_8", "choke-collar_21", "fish-food_5"), 
        MN(.0f, "dog-food_10",
                "cat-food_8", "turkey-caller_20", "turtle-pellets_2"), 
        MO(.0f, "dog-food_10",
                "cat-food_8", "cow-dung_16", "pig-feed_4"), 
        MS(.0f, "dog-food_10",
                "cat-food_8", "choke-collar_4", "fish-food_4"), 
        MT(.0f, "dog-food_10",
                "cat-food_8", "cow-dung_23", "horse-feed_19"), 
        NC(.0f, "dog-food_10",
                "cat-food_8", "pig-feed_24", "fish-food_2"), 
        ND(.0f, "dog-food_10",
                "cat-food_8", "cow-dung_12", "hay-bail_5"), 
        NE(.0f, "dog-food_10",
                "cat-food_8", "cow-dung_16", "pig-feed_18"), 
        NH(.0f, "dog-food_10",
                "cat-food_8", "fuzzy-collar_6", "cow-dung_11"), 
        NJ(.0f, "dog-food_10",
                "cat-food_8", "choke-collar_4", "fish-food_5"), 
        NM(.0f, "dog-food_10",
                "cat-food_8", "choke-collar_9", "turtle-pellets_3"), 
        NV(.0f, "dog-food_10",
                "cat-food_8", "choke-collar_2", "cow-dung_7"), 
        NY(.2f, "dog-food_10", "cat-food_8", "steel-leash_20", 
                "fish-food_20", "seal-spray_25"),
        OH(.0f, "dog-food_10", "cat-food_8", "steel-leash_10", 
                "fish-food_15"),
        OK(.1f,
                "dog-food_10", "cat-food_8", "duck-caller_13",
                "rodent-cage_40", "hay-bail_5", "cow-dung_2"),
        OR(.0f,
                "dog-food_10", "cat-food_8", "duck-caller_16",
                "rodent-cage_25", "hay-bail_2", "cow-dung_2"),
        PA(.0f,
                "dog-food_10", "cat-food_8", "fish-food_11",
                "hay-bail_7", "cow-dung_2"),
        RI(.0f,
                "dog-food_10", "cat-food_8", "fish-bait_12",
                "hay-bail_5", "cow-dung_2"),
        SC(.0f,
                "dog-food_10", "cat-food_8", "choke-collar_18",
                "hay-bail_9", "cow-dung_4"),
        SD(.0f,
                "dog-food_10", "cat-food_8", "duck-caller_7",
                "hay-bail_5", "cow-dung_2"),
        TN(.0f,
                "dog-food_10", "cat-food_8", "duck-caller_6",
                "horse-feed_24", "pig-feed_8", "cow-dung_2"),
        TX(.0f,
                "dog-food_10", "cat-food_8", "pig-feed_3",
                "hay-bail_8", "cow-dung_3"),
        UT(.0f,
                "dog-food_10", "cat-food_8", "fuzzy-collar_14",
                "hay-bail_2", "cow-dung_2"),
        VA(.0f,
                "dog-food_10", "cat-food_8", "choke-collar_14",
                "hay-bail_2", "fish-food_3"),
        VT(.0f,
                "dog-food_10", "cat-food_8", "fuzzy-collar_6",
                "hay-bail_2", "cow-dung_6"),
        WA(.0f,
                "dog-food_10", "cat-food_8",
                "hay-bail_4", "cow-dung_4"),
        WI(.0f,
                "dog-food_10", "cat-food_8",
                "fuzzy-collar_3", "cow-dung_5"),
        WV(.0f,
                "dog-food_10", "cat-food_8", "duck-caller_9",
                "hay-bail_5", "cow-dung_2"),
        WY(.0f,
                "dog-food_10", "cat-food_8", "horse-feed_29",
                "hay-bail_18", "cow-dung_17");
